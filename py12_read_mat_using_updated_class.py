...
# from pykeri.thermoelectrics.a import printtest 
...
## choose DB
db_mode = 'teMatDb'
df_db_meta = pd.read_excel("./"+"_tematdb_metadata_v1.0.0-20230407_brjcsjp.xlsx", sheet_name='list', )
sampleid = 2
...
if (0):
    ...
    ## print mat tep
    df_db_csv = pd.read_csv("./data_csv/"+"tematdb_v1.0.0_completeTEPset.csv")
