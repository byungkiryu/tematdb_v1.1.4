...
mesh = stack_fast_block_mesh(leg1, 'above', plate)
t.print_passed()
mesh = stack_fast_block_mesh(leg2, 'above', mesh)
t.print_passed()
mesh = stack_fast_block_mesh(leg3, 'above', mesh)
t.print_passed()
mesh = stack_fast_block_mesh(leg4, 'above', mesh)
t.print_passed()
#
# try again
mesh = stack_fast_block_mesh(leg2, 'above', mesh)
...
filename = 'test_stack_3d_fast.vtk'
mesh.write(filename)
